...
import { VehicleSchemas, DealershipSchemas } from "./lib/schemas/index.js";
...
export class ToyotaClient {
   ...
   *
   * @param {Region} [region] Either a region name or 5 digit zip code. Defaults to "NATIONAL". Of type {@link Region}.
   * @param {Language} [language] 2 character language code. Defaults to "EN" (English). Of type {@link Language}.
  ...
  public async getAllVehicles<TransformedType = VehicleResponseBody>(
    ...
    return VehicleSchemas.GetAllVehiclesFunctionSchema<TransformedType>().implement(
      (
        region: Region = "NATIONAL",
        language: Language = "EN",
        transformer?: (
        ...
        return this.makeRequest<VehicleResponseBody, TransformedType>(
          ...
          VehicleSchemas.ResponseBodySchema,
          transformer
        );
      }
  ...
  public async getVehicle<TransformedType = VehicleResponseBody>(
    ...
    return VehicleSchemas.GetVehicleFunctionSchema<TransformedType>().implement(
      (
        modelCode: string,
        year: number,
        region: Region = "NATIONAL",
  ...
  public async getVehicleGrade<TransformedType = VehicleGradeResponseBody>(
    ...
    return VehicleSchemas.GetVehicleGradeFunctionSchema<TransformedType>().implement(
      (
        modelCode: string,
        year: number,
        gradeName: string,
        ...
        return this.makeRequest<VehicleGradeResponseBody, TransformedType>(
          ...
          VehicleSchemas.GradeResponseBodySchema,
          transformer
        );
      }
  ...
  public async getDealerships<TransformedType = DealershipResponseBody>(
    ...
    return DealershipSchemas.GetDealershipsFunctionSchema<TransformedType>()
      .implement(
        (
          zipCode: number,
          transformer?: (
          ...
          return this.makeRequest<DealershipResponseBody, TransformedType>(
            ...
            DealershipSchemas.ResponseBodySchema,
            transformer
          );
        }
      )(zipCode, transformer)
